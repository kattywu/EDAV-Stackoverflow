...
ggplot(df1_count,
  ...
  scale_fill_manual(values = c("#6D5BAE", "#5F6EB5", "#4F7EBA", "#3F8DBD", "#329BBE", "#2FA7BE", "#38B2BE", "#49BCBC", "#5DC6BB", "#72CEB9", "#87D5B8", "#9BDCB8", "#AEE1B9", "#BFE5BA", "#CEE8BB")) +
...
If tags are ordered by the frequency of occurrences in our sample per year, there is a clear difference in the usage of each tag. Not a single tag stays at a consistent ranking throughout the 7 years. However there are a few interesting trends:
- amazon-web-services is the tag that was ranked the most consistently, it maintains the same rank from 2017-2021.
- ajax and xcode are the next most consistent tags, maintaining their respective ranks from 2018-2021.
- Our sample from 2016 does not contain any occurrences of the tag flutter and as a result is one element smaller
