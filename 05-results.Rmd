...
## Distribution of Interaction for 8 Programming Languages Tags
...
Based on the above Ridgeline plots, javascript, java, and c# seem to have the greatest variation in total comments, total views, and total answers across all years. They all appear to have more than one mode (peak of usage) in all three categories, unlike the other programming language tags which have only one peak, these three have 


## Programming Languanges Tags by Year
...
df1_count %>%
  ...
  ggplot(aes(TotalAnswers, color = year, fill = year)) +
    ...
    xlab("Total Amount of Answers Received")
```
