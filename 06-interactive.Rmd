...
<script src="scripts/js/lib/d3.parcoords.js"></script>
<script src="scripts/js/lib/d3.underscore.math.js"></script>
<script src="scripts/js/lib//d3.divgrid.js"></script>
<link href="scripts/css/d3.parcoords.css" rel="stylesheet">
<link href="scripts/css/bigdata.parallelcoordinates.css" rel="stylesheet">
...
<div id="grid"></div>
<script type="text/javascript" src="scripts/js/bigdata.parallelcoordinates.js"></script>
